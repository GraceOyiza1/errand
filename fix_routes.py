...
files = {
    Path('src/app/(admin)/layout.tsx'): '''import React from 'react';
...
''',
    Path('src/app/(admin)/admin/dashboard/page.tsx'): '''export default function AdminDashboardPage() {
    return (
...
''',
    Path('src/app/(customer)/customer/orders/page.tsx'): '''export default function CustomerOrdersPage() {
    return (
        <div className="space-y-6">
            <div>
